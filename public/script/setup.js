...
(function(credentials, mode){
	...
	var line_widths = [
            {value: 1, background: 'url(icons/pr2_sprite.png) -308px -56px', title: '1px'},
            {value: 2, background: 'url(icons/pr2_sprite.png) -336px -56px', title: '2px'},
            {value: 5, background: 'url(icons/pr2_sprite.png) -364px -56px', title: '5px'},
            {value: 7, background: 'url(icons/pr2_sprite.png) -392px -56px', title: '7px'},
            {value: 10, background: 'url(icons/pr2_sprite.png) -420px -56px', title: '10px'},
            {value: 15, background: 'url(icons/pr2_sprite.png) -448px -56px', title: '15px'},
            {value: 20, background: 'url(icons/pr2_sprite.png) -476px -56px', title: '20px'}
        ];
	var	colors = [
            {value: 'Transparent', title: 'Transparent', background: 'url(icons/pr2_sprite.png) -362px -28px'},
    ...
    var canvas_backgrounds = [
		{title: "Simply white", value: "url(assets/backgrounds/simply-white.png)", background: "url(assets/backgrounds-thumbs/simply-white.png)"},
		{title: "Low contrast", value: "url(assets/backgrounds/low-contrast.png)", background: "url(assets/backgrounds-thumbs/low-contrast.png)"},
		{title: "Small blocked grid", value: "url(assets/backgrounds/block-grid-small.png)", background: "url(assets/backgrounds-thumbs/block-grid-small.png)"},
        {title: "Medium blocked grid", value: "url(assets/backgrounds/block-grid-medium.png)", background: "url(assets/backgrounds-thumbs/block-grid-medium.png)"},
        {title: "Large blocked grid", value: "url(assets/backgrounds/block-grid-large.png)", background: "url(assets/backgrounds-thumbs/block-grid-large.png)"},
		{title: "Writing paper", value: "url(assets/backgrounds/writing-paper.png)", background: "url(assets/backgrounds-thumbs/writing-paper.png)"},
		{title: "Grid of dots", value:  "url(assets/backgrounds/dots.png)", background: "url(assets/backgrounds-thumbs/dots.png)"},
		{title: "Medium inverted grid", value: "url(assets/backgrounds/block-grid-medium-invert.png)", background: "url(assets/backgrounds-thumbs/block-grid-medium-invert.png)"},
		{title: "School Board", value: "url(assets/backgrounds/school-board.png)", background: "url(assets/backgrounds-thumbs/school-board.png)"},
		{title: "School Board grid", value: "url(assets/backgrounds/school-board-grid.png)", background: "url(assets/backgrounds-thumbs/school-board-grid.png)"},
        {title: "world map", value: "url(assets/backgrounds/world-map.png) 0 0 / 100% 100%", background: "url(assets/backgrounds-thumbs/world-map.png)"},
        {title: "Music bars", value: "url(assets/backgrounds/music-bars.png)", background: "url(assets/backgrounds-thumbs/music-bars.png)"}
	];

    var shapes = {
        line: {
            title: "Draw a line",
            background: "url(icons/pr2_sprite.png) -84px 0",
        ...
        arrow: {
            title: "Draw an arrow",
            background: "url(icons/pr2_sprite.png) -308px 0",
            shapeFunction: function(context, start_x, start_y, end_x, end_y) {
        ...
        cosinus: {
            ...
            background: "url(icons/pr2_sprite.png) 0 -28px",
            shapeFunction: function(context, start_x, start_y, end_x, end_y) {
        ...
        sinus: {
            title: "Draw a sinus",
            background: "url(icons/pr2_sprite.png) -28px -28px",
            shapeFunction: function(context, start_x, start_y, end_x, end_y) {
                var _end_x = end_x > start_x ? end_x: start_x,
                    _start_x = end_x > start_x ? start_x: end_x,
                    baseY = (end_y - start_y) / 2 + start_y,
        ...
        axis: {
            title: "Draw an axis",
            background: "url(icons/pr2_sprite.png) -364px 0",
            shapeFunction: function(context, start_x, start_y, end_x, end_y) {
                context.beginPath();
        ...
        triangle: {
            ...
            background: "url(icons/pr2_sprite.png) -56px 0",
            shapeFunction: function(context, start_x, start_y, end_x, end_y) {
                context.beginPath();
                context.moveTo(start_x, start_y);
        ...
        triangle2: {
            title: "Draw a triangle",
            background: "url(icons/pr2_sprite.png) -336px 0",
            shapeFunction: function(context, start_x, start_y, end_x, end_y) {
                context.beginPath();
                context.moveTo(start_x + (end_x - start_x) / 2, start_y);
                context.lineTo(end_x, end_y);
        ...
        rectangle: {
            ...
            background: "url(icons/pr2_sprite.png) 0 0",
            shapeFunction: function(context, start_x, start_y, end_x, end_y) {
                context.beginPath();
        ...
        circle: {
            title: "Draw a circle",
            background: "url(icons/pr2_sprite.png) -28px 0",
            shapeFunction: function(context, start_x, start_y, end_x, end_y) {
        ...
        elipse: {
            ...
            background: "url(icons/pr2_sprite.png) -196px 0",
            shapeFunction: function(context, start_x, start_y, end_x, end_y) {
        ...
        star: {
            title: "Draw a star",
            background: "url(icons/pr2_sprite.png) -252px 0",
        ...
        roundedsquare: {
            ...
            background: "url(icons/pr2_sprite.png) -196px -28px",
            shapeFunction: function(context, start_x, start_y, end_x, end_y) {
                var d_x = end_x - start_x, center_x = start_x + d_x / 2,
                    d_y = end_y - start_y, center_y = start_y + d_y / 2,
        ...
        balloon: {
            ...
            background: "url(icons/pr2_sprite.png) -224px -28px",
            shapeFunction: function(context, start_x, start_y, end_x, end_y) {
                var d_x = end_x - start_x, center_x = start_x + d_x / 2,
                    d_y = end_y - start_y, center_y = start_y + d_y / 2,
                    tension = Math.floor(Math.min( Math.abs(d_x), Math.abs(d_y) ) / 5);
        ...
        connector_h: {
            ...
            background: "url(icons/pr2_sprite.png) -112px -28px",
            shapeFunction: function(context, start_x, start_y, end_x, end_y) {
                var d_x = end_x - start_x, center_x = start_x + d_x / 2;
        ...
        connector_v: {
            ...
            background: "url(icons/pr2_sprite.png) -140px -28px",
            shapeFunction: function(context, start_x, start_y, end_x, end_y) {
	...
	PR2.whiteboard.onPropertyChange(function(property, value) {
		switch (property) {
			...
			case 'background':
				// distinguish between simple values from the toolbar, or data url images added to the whiteboard backgrounf
    ...
    }).setDimensions(1400, 768).setProperties({
        lineJoin: 'round',
        lineCap: 'round',
        strokeStyle: 'black',
        fillStyle: "Transparent",
        lineWidth: 1,
        background: 'url(assets/backgrounds/block-grid-medium.png)',
        shape: 'line',
        action: 'paint'
    });
	console.log('Windows height:' +window.height+', width: '+window.width);
	...
	(function() {
        ...
        player_container.style.top = chat_container.offsetTop + chat_container.offsetHeight + 'px';
