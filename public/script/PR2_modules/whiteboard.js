...
PR2.whiteboard = (function(self) {
	...
	shapeFunction = function(context, oldx_, old_y, new_x, new_y){}, // Holds internal references to the shapeFunction
	...
	var container = $.create('div', document.body, {"id" : "pr2_canvas_container"}),
	    ...
	    remote_pointer = $.create('div', document.body, {"id" : "pr2_remote_pointer"}, {"backgroundImage" : "url(icons/pointer.png)"}),
	...
	var _setDimensions = function(width, height) {
		...
		horizontal_helper.style.left = canvas.offsetLeft + 'px';
		horizontal_helper.style.width = canvas.offsetWidth + 'px';
		horizontal_helper.style.top = canvas.offsetTop + 'px';
		vertical_helper.style.left = canvas.offsetLeft + 'px';
		vertical_helper.style.height = canvas.offsetHeight + 'px';
		vertical_helper.style.top = canvas.offsetTop + 'px';
		top_layer.style.height = canvas.offsetTop + 'px';
		left_layer.style.width = canvas.offsetLeft + 'px';
		right_layer.style.left = canvas.offsetLeft + canvas.offsetWidth -1 + 'px';
        right_layer.style.height = canvas.offsetTop + canvas.offsetHeight + 'px';
		bottom_layer.style.top = canvas.offsetTop + canvas.offsetHeight - 1 + 'px';
	};
