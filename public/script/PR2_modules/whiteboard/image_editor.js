    ...
    self = {
        ...
        moveTo: function(x, y) {
            if(!$.utils.isInt(x) || $.utils.isInt(y))  {
                throw new Error('x and y must both be integer values');
            }
            _moveTo(x, y);
            return this
        },
        ...
        resize: function(width, height) {
            if(!$.utils.isInt(width) || $.utils.isInt(height))  {
                throw new Error('width and height must both be integer values');
            }
